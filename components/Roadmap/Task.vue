<template>
    <div :class="$style.wrapper" :style="{width: task.size + 'px', left: left + 'px'}" ref="wrapper" v-if="size > 0">
...
const initSize = () => {
    return props.task.size * unit.value;
}

const initLeft = () => {
    return props.task.start * unit.value;
}
